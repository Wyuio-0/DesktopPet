...
a = Analysis(
    ...
    binaries=[],
    datas=[('app.ico', '.')],
    hiddenimports=['cv2', 'PyQt5.QtMultimedia'] + _tts_imports + ['psutil', 'PIL.ImageGrab', 'pet.memory', 'pet.ai_settings', 'pet.theme', 'pet.timers', 'pet.tray', 'pet.menu', 'pet.focus', 'pet.input_controller', 'pet.wander', 'pet.sedentary'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
